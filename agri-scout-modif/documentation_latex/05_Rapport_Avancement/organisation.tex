...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.85\textwidth]{images/robot_assemblee_final.jpg}
    \fbox{\parbox{0.85\textwidth}{\centering\vspace{0.4cm}
    \small\textit{[PHOTO : Vue d'ensemble du robot AGRI-Scout finalisé]}
    \vspace{0.4cm}}}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        % \includegraphics[width=\textwidth]{images/mecanisme_sonde_detail.jpg}
        \fbox{\parbox{\textwidth}{\centering\vspace{0.4cm}
        \small\textit{[PHOTO : Mécanisme de sondage]}
        \vspace{0.4cm}}}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        % \includegraphics[width=\textwidth]{images/electronique_interne.jpg}
        \fbox{\parbox{\textwidth}{\centering\vspace{0.4cm}
        \small\textit{[PHOTO : Électronique interne]}
        \vspace{0.4cm}}}
    \end{minipage}
