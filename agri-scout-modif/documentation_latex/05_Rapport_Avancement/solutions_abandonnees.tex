...
L'IMU BNO055 avait été envisagée pour corriger les dérives de trajectoire dues au glissement (\textit{skid-steering}). En pratique, le champ magnétique des moteurs perturbait la boussole interne, rendant les données de cap peu fiables. L'odométrie visuelle par centroïde de ligne, couplée au LiDAR, a suffi pour les missions de suivi de rang.
